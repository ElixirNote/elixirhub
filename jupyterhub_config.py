...
#  Default: False
# c.Application.show_config_json = True
...
## DEPRECATED since version 0.8 : Use ConfigurableHTTPProxy.api_url
#  Default: 0
c.JupyterHub.proxy_api_port = 8002
...
## DockerSpawner https://github.com/jupyterhub/dockerspawner/blob/main/dockerspawner/dockerspawner.py
...
# from jupyterhub.singleuser import main
c.Spawner.cmd = ['jupyterhub-singleuser', '--ip=0.0.0.0', '--allow-root']
# c.Spawner.cmd = ['jupyterhub-singleuser', '--ip=0.0.0.0', '--allow-root', '--notebook-dir=/data/notebooks', '--mirror-sync', '--extensions-in-dev-mode']
...
#  Default: None
# c.Spawner.hub_connect_url = 'http://{}:8081'.format(public_ips()[0])
